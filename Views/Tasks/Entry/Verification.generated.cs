...
"ecklistAnchor.attr(\"href\", \"/dashboard/purchase/tasks/entry/checklist/\" + tranId" +
");\r\n\r\n            var journalAdviceAnchor = $(\"<a title=\'View Journal Advice\'><i" +
" class=\'print icon\'></i></a>\");\r\n            journalAdviceAnchor.attr(\"href\", \"j" +
"avascript:void(0);\");\r\n            journalAdviceAnchor.attr(\"onclick\", \"showJour" +
"nalAdvice(\" + tranId + \");\");\r\n\r\n            var inventoryAdviceAnchor = $(\"<a t" +
"itle=\'View Purchase Invoice\'><i class=\'zoom icon\'></i></a>\");\r\n            inven" +
"toryAdviceAnchor.attr(\"href\", \"javascript:void(0);\");\r\n            inventoryAdvi" +
"ceAnchor.attr(\"onclick\", \"showPuchaseInvoice(\" + tranId + \");\");\r\n\r\n\r\n          " +
...
"rl = \"/dashboard/finance/tasks/journal/view\";\r\n                var data = JSON.s" +
"tringify(model);\r\n                return window.getAjaxRequest(url, \"POST\", data" +
");\r\n            };\r\n\r\n            var model = getModel();\r\n\r\n            var aja" +
"x = request(model);\r\n\r\n            ajax.success(function(response) {\r\n          " +
"      displayTable(target, response);\r\n                target.removeClass(\"loadi" +
...
"t Transaction\");\r\n        subheader.html(window.stringFormat(\"TranId: #{0}\", tra" +
"nId));\r\n        header.removeClass(\"green\").addClass(\"red\");\r\n\r\n        if (appr" +
"ove) {\r\n            header.html(\"Approve Transaction\");\r\n            header.remo" +
"veClass(\"red\").addClass(\"green\");\r\n        };\r\n\r\n        modal.modal(\'setting\', " +
...
"ar reason = reasonTextArea.val();\r\n\r\n            return {\r\n                TranI" +
"d: tranId,\r\n                Reason: reason\r\n            };\r\n        };\r\n\r\n      " +
"  function request(model, type) {\r\n            var url = \"/dashboard/purchase/ta" +
"sks/entry/verification/\" + type;\r\n            var data = JSON.stringify(model);\r" +
"\n\r\n            return window.getAjaxRequest(url, \"POST\", data);\r\n        }\r\n\r\n  " +
"      var model = getModel();\r\n        var type = approve ? \"approve\" : \"reject\"" +
";\r\n\r\n        var ajax = request(model, type);\r\n\r\n        ajax.success(function (" +
"response) {\r\n            var cascadingTranId = parseFloat(response);\r\n\r\n        " +
"    if (cascadingTranId) {\r\n                journalView.find(\"tr td:nth-child(3)" +
"\").each(function (i) {\r\n                    var tranId = parseFloat($(this).text" +
"() || 0);\r\n\r\n                    if (cascadingTranId === tranId) {\r\n            " +
"            removeRow(i);\r\n                    };\r\n                });\r\n        " +
"    };\r\n\r\n            journalView.find(\"input:checked\").first().parent().parent(" +
").parent().remove();\r\n            hideModal();\r\n        });\r\n\r\n        ajax.fail" +
"(function (xhr) {\r\n            window.logAjaxErrorMessage(xhr);\r\n        });\r\n\r\n" +
"        return false;\r\n    });\r\n\r\n    $(document).keyup(function (e) {\r\n        " +
"if (e.ctrlKey) {\r\n            var rowNumber = e.keyCode - 47;\r\n\r\n            if " +
"(rowNumber < 10) {\r\n                journalView.find(\"tr\").eq(rowNumber).find(\"i" +
"nput\").trigger(\'click\');\r\n            };\r\n        };\r\n    });\r\n\r\n    shortcut.ad" +
...
"P.Purchases/Reports/Invoice.xml?transaction_master_id=\" + tranId);\r\n\r\n        se" +
"tTimeout(function () {\r\n            $(\".advice.modal\")\r\n                .modal(\'" +
"setting\', \'transition\', \'horizontal flip\')\r\n                .modal({\r\n          " +
"          blurring: true\r\n                })\r\n                .modal(\"show\");\r\n\r" +
"\n        }, 300);\r\n    };\r\n    function showJournalAdvice(tranId) {\r\n        $(\"" +
".modal iframe\").attr(\"src\", \"/dashboard/reports/source/Areas/MixERP.Finance/Repo" +
"rts/JournalEntry.xml?transaction_master_id=\" + tranId);\r\n\r\n        setTimeout(fu" +
"nction () {\r\n            $(\".advice.modal\")\r\n                .modal(\'setting\', \'" +
