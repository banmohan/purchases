...
WriteLiteral("\r\n\r\n\r\n");
            ...
            #line 10 "..\..\Views\Tasks\Entry\Index.cshtml"
...
"   AddNewText: \"Add New\",\r\n        AddNewUrl: \"/dashboard/purchase/tasks/entry/n" +
"ew\",\r\n        ReturnText: \"Return\",\r\n        ReturnUrl: \"javascript:void(0);\",\r\n" +
"        Book: \"Purchase\",\r\n        ChecklistUrl: \"/dashboard/purchase/tasks/entr" +
"y/checklist/{tranId}\",\r\n        AdviceButtons: [\r\n            {\r\n               " +
" Title: \"View Purchase Invoice\",\r\n                Href: \"javascript:void(0);\",\r\n" +
"                OnClick: \"showInvoice({tranId});\"\r\n            }\r\n        ]\r\n   " +
" });\r\n\r\n    $(\"#ReturnButton\").click(function () {\r\n        function getSelected" +
"Item() {\r\n            const selected = $(\"#JournalView\").find(\"input:checked\").f" +
"irst();\r\n\r\n            if (selected.length) {\r\n                const row = selec" +
"ted.parent().parent().parent();\r\n                const id = row.find(\"td:nth-chi" +
"ld(3)\").html();\r\n                return parseInt(id);\r\n            };\r\n\r\n       " +
"     return 0;\r\n        };\r\n\r\n        const selected = getSelectedItem();\r\n     " +
"   if (selected) {\r\n            const url = \"/dashboard/purchase/tasks/return/ne" +
"w?TransactionMasterId=\" + selected;\r\n            document.location = url;\r\n     " +
"       return;\r\n        };\r\n\r\n        window.displayMessage(\"Please select an it" +
"em from the grid.\");\r\n    });\r\n\r\n    function showInvoice(tranId) {\r\n        $(\"" +
".advice.modal iframe\").attr(\"src\", \"/dashboard/reports/source/Areas/MixERP.Purch" +
"ases/Reports/Invoice.xml?transaction_master_id=\" + tranId);\r\n\r\n        setTimeou" +
"t(function () {\r\n            $(\".advice.modal\")\r\n                .modal(\'setting" +
