...
WriteLiteral("                        ");
            ...
            #line 24 "..\..\Views\Tasks\Entry\New.cshtml"
...
WriteLiteral("                        ");
            ...
            #line 27 "..\..\Views\Tasks\Entry\New.cshtml"
                   Write(meta.Name);
...
WriteLiteral("                        ");
            ...
            #line 30 "..\..\Views\Tasks\Entry\New.cshtml"
...
WriteLiteral("                        ");
            ...
            #line 33 "..\..\Views\Tasks\Entry\New.cshtml"
                   Write(meta.OfficeName);
...
".item\");\r\n                var model = [];\r\n\r\n                $.each(items, funct" +
"ion () {\r\n                    var el = $(this);\r\n                    var itemId " +
"= parseInt(el.attr(\"data-item-id\"));\r\n                    var quantity = parseIn" +
"t(el.find(\"input.quantity\").val());\r\n                    var unitId = parseInt(e" +
"l.find(\"select.unit\").val());\r\n                    var price = parseFloat(el.fin" +
"d(\"input.price\").val() || 0);\r\n                    var discount = parseFloat(el." +
"find(\"input.discount\").val() || 0);\r\n\r\n                    model.push({\r\n       " +
"                 StoreId: $(\"#StoreSelect\").val(),\r\n                        Item" +
"Id: itemId,\r\n                        Quantity: quantity,\r\n                      " +
"  UnitId: unitId,\r\n                        Price: price,\r\n                      " +
"  Discount: discount\r\n                    });\r\n                });\r\n\r\n          " +
"      return model;\r\n            };\r\n\r\n            var valueDate = $(\"#ValueDate" +
"InputDate\").datepicker(\"getDate\");\r\n            var bookDate = $(\"#BookDateInput" +
"Date\").datepicker(\"getDate\");\r\n            var costCenterId = $(\"#CostCenterSele" +
"ct\").val();\r\n            var referenceNumber = $(\"#ReferenceNumberInputText\").va" +
"l();\r\n            var statementReference = $(\"#StatementReferenceInputText\").val" +
"();\r\n            var supplierId = $(\"#SupplierSelect\").val();\r\n            var p" +
"riceTypeId = $(\"#PriceTypeSelect\").val();\r\n            var shipperId = $(\"#Shipp" +
...
" if (!confirmed) {\r\n            return;\r\n        };\r\n\r\n\r\n        $(\"#CheckoutBut" +
"ton\").addClass(\"loading\");\r\n\r\n        var ajax = request(model);\r\n\r\n        ajax" +
".success(function (response) {\r\n            var id = response;\r\n            docu" +
"ment.location = \"/dashboard/purchase/tasks/entry/checklist/\" + id;\r\n        });\r" +
"\n\r\n        ajax.fail(function (xhr) {\r\n            $(\"#CheckoutButton\").removeCl" +
"ass(\"loading\");\r\n            alert(JSON.stringify(xhr));\r\n        });\r\n    });\r\n" +
"</script>\r\n\r\n<script>\r\n    $(\"#ClearScreenButton\")\r\n        .unbind(\"click\")\r\n  " +
"      .bind(\"click\",\r\n            function () {\r\n                clearScreen();\r" +
"\n            });\r\n\r\n    function clearScreen() {\r\n        $(\"#PurchaseItems\").ht" +
"ml(\"\");\r\n        window.updateTotal();\r\n    };\r\n</script>\r\n\r\n<script>\r\n    funct" +
"ion displayFieldBinder(el, url) {\r\n        function request() {\r\n            ret" +
"urn window.getAjaxRequest(url);\r\n        };\r\n\r\n        var ajax = request();\r\n\r\n" +
"        ajax.success(function (response) {\r\n            var options = \"\";\r\n\r\n   " +
"         $.each(response, function () {\r\n                var option = \"<option v" +
"alue=\'{key}\'>{value}</option>\";\r\n                option = option.replace(\"{key}\"" +
", this.Key);\r\n                option = option.replace(\"{value}\", this.Value);\r\n\r" +
"\n                options += option;\r\n            });\r\n\r\n            el.html(opti" +
"ons);\r\n        });\r\n    };\r\n\r\n    function loadStores() {\r\n        displayFieldB" +
"inder($(\"#StoreSelect\"), \"/api/forms/inventory/stores/display-fields\");\r\n    };\r" +
"\n\r\n    function loadShippers() {\r\n        displayFieldBinder($(\"#ShipperSelect\")" +
", \"/api/forms/inventory/shippers/display-fields\");\r\n    };\r\n\r\n    function loadC" +
"ostCenters() {\r\n        displayFieldBinder($(\"#CostCenterSelect\"), \"/api/forms/f" +
"inance/cost-centers/display-fields\");\r\n    };\r\n\r\n    function loadPriceTypes() {" +
"\r\n        displayFieldBinder($(\"#PriceTypeSelect\"), \"/api/forms/purchase/price-t" +
"ypes/display-fields\");\r\n    };\r\n\r\n    function loadSuppliers() {\r\n        displa" +
"yFieldBinder($(\"#SupplierSelect\"), \"/api/forms/inventory/suppliers/display-field" +
"s\");\r\n    };\r\n\r\n    loadStores();\r\n    loadPriceTypes();\r\n    loadSuppliers();\r\n" +
"    loadCostCenters();\r\n    loadShippers();\r\n</script>\r\n\r\n<script>\r\n    setTimeo" +
"ut(function () {\r\n        $(\".decimal\").number(true, window.currencyDecimalPlace" +
"s, \".\", \"\");\r\n    }, 100);\r\n\r\n\r\n    window.overridePath = \"/dashboard/purchase/t" +
"asks/entry\";\r\n</script>");
