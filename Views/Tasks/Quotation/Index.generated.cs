...
namespace ASP
{
    ...
    #line 1 "..\..\Views\Tasks\Quotation\Index.cshtml"
    ...
    public partial class _Views_Tasks_Quotation_Index_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        ...
        public override void Execute()
        {
            ...
            #line 4 "..\..\Views\Tasks\Quotation\Index.cshtml"
...
WriteLiteral("\r\n\r\n\r\n");
            ...
            #line 10 "..\..\Views\Tasks\Quotation\Index.cshtml"
...
"     AddNewText: \"Add New\",\r\n        AddNewUrl: \"/dashboard/purchase/tasks/quota" +
"tion/new\",\r\n        ReturnText: \"Return\",\r\n        ReturnUrl: \"javascript:void(0" +
");\",\r\n        Book: \"Purchase Quotation\",\r\n        ChecklistUrl: \"/dashboard/pur" +
"chase/tasks/quotation/checklist/{tranId}\",\r\n        AdviceButtons: [\r\n          " +
"  {\r\n                Title: \"View Purchase Quotation\",\r\n                Href: \"j" +
"avascript:void(0);\",\r\n                OnClick: \"showInvoice({tranId});\"\r\n       " +
"     }\r\n        ]\r\n    });\r\n\r\n    $(\"#ReturnButton\").click(function () {\r\n      " +
"  function getSelectedItem() {\r\n            const selected = $(\"#JournalView\").f" +
"ind(\"input:checked\").first();\r\n\r\n            if (selected.length) {\r\n           " +
"     const row = selected.parent().parent().parent();\r\n                const id " +
"= row.find(\"td:nth-child(3)\").html();\r\n                return parseInt(id);\r\n   " +
"         };\r\n\r\n            return 0;\r\n        };\r\n\r\n        const selected = get" +
"SelectedItem();\r\n        if (selected) {\r\n            const url = \"/dashboard/pu" +
"rchase/tasks/return/new?TransactionMasterId=\" + selected;\r\n            document." +
"location = url;\r\n            return;\r\n        };\r\n\r\n        window.displayMessag" +
"e(\"Please select an item from the grid.\");\r\n    });\r\n\r\n    function showQuotatio" +
"n(tranId) {\r\n        $(\".advice.modal iframe\").attr(\"src\", \"/dashboard/reports/s" +
"ource/Areas/MixERP.Purchases/Reports/Order.xml?transaction_master_id=\" + tranId)" +
";\r\n\r\n        setTimeout(function () {\r\n            $(\".advice.modal\")\r\n         " +
