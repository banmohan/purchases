...
namespace MixERP.Purchases.DAL.Backend.Service
{
    ...
    {
        public static async Task<List<ItemView>> GetItems(string tenant)
        {
        ...
        public static async Task<decimal> GetCostPrice(string tenant, int itemId, int supplierId, int unitId)
        {
